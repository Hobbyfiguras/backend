# Generated by Django 2.1.5 on 2020-05-22 07:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', django_resized.forms.ResizedImageField(blank=True, crop=None, force_format=None, keep_meta=True, null=True, quality=0, size=[1920, 1080], upload_to=FigureSite.models.ClassifiedImageRename())),
                ('primary', models.BooleanField(default=False)),
                ('nsfw', models.BooleanField(default=False)),
                ('ad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='FigureSite.ClassifiedAD')),
            ],
        ),
        migrations.CreateModel(
            name='ClassifiedReview',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(editable=False)),
                ('content', models.TextField(max_length=40000)),
        ...
        migrations.AddField(
            model_name='user',
            name='classifieds_negative_review_count',
            field=models.PositiveIntegerField(default=0, editable=False),
        ),
        migrations.AddField(
            model_name='user',
            name='classifieds_positive_review_count',
            field=models.PositiveIntegerField(default=0, editable=False),
        ),
        migrations.AddField(
            model_name='classifiedreview',
            name='creator',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reivews_made', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='classifiedreview',
            name='for_user',
        ...
        migrations.AddField(
            model_name='classifiedreview',
            name='related_ad',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='FigureSite.ClassifiedAD'),
        ),
        migrations.AddField(
            model_name='classifiedad',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='FigureSite.ClassifiedCategory'),
        ),
        migrations.AddField(
            model_name='classifiedad',
            name='creator',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='published_ads', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='classifiedad',
            name='sold_to',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='articles_bought', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='privatemessage',
            name='related_ad',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='FigureSite.ClassifiedAD'),
        ),
        migrations.AddField(
            model_name='thread',
            name='related_items',
